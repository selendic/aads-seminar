...
class TestPrefixTree(unittest.TestCase):
	...
	def setUp(self):
		"""Set up a new PrefixTree for each test."""
	...
	def test_remove(self):
		"""Test removing strings from the prefix tree."""
		self.tree.insert("hello")
		self.tree.insert("help")
	...
	def test_is_leaf(self):
		"""Test the is_leaf method of PrefixTreeNode."""
		root = self.tree.root
	...
	def test_visualize(self):
		...
		try:
			self.tree.visualize(file_name="test_prefix_tree", directory_name=".", view=False)
		except Exception as e:
			self.fail(f"Visualization failed with exception: {e}")
		finally:
			os.remove("test_prefix_tree")
			os.remove("test_prefix_tree.png")
